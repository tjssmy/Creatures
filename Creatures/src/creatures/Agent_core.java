...
public class Agent_core {
	...
	int SCALEFACTOR;   //multiply x, y creature locations by this to get pixel locations
	int WORLD_X;  //actual dimension of pond
	int WORLD_Y;
	...
	public Agent_core(int pond_X, int pond_Y, int scale)
	{
		SCALEFACTOR = scale;
		WORLD_X = pond_X / SCALEFACTOR; 
		WORLD_Y = pond_Y / SCALEFACTOR; 
	}
...
//								int ind = get_creature_index(i1, i2);
	...
	public void new_food(float xf, float yf)  {
	...
	public void move_creatures(int timeClock)  {
		int loss1 = 0;
		int loss2 = 0;
		int cr_found = -1;
		char dir = 'x';
